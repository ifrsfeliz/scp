...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { celular: @professor.celular, cpf: @professor.cpf, email: @professor.email, nome: @professor.nome, rg: @professor.rg, telefone: @professor.telefone }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { celular: @professor.celular, cpf: @professor.cpf, email: @professor.email, nome: @professor.nome, rg: @professor.rg, telefone: @professor.telefone }
    assert_redirected_to professor_path(assigns(:professor))
  end
